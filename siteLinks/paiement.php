...
<body>
    ...
    <form method="post" action="../sae_martin/index.php" class="flexTop">
        <button class="backButton" onclick="history.back()"><img src="asset/icons/arrow-down.svg"></button>
        <div id="paiement">
            <div id="infosVoyage">
                <h2>Votre voyage</h2>
                <p><a class="h3">Dates</a><a>19 - 24 oct.</a></p>
                <p><a class="h3">Voyageurs</a><a>1 voyageur</a></p>
            </div>
            <div id="infosPaiement">
                <h2>Validez et payez</h2>
                <p>Payez avec</p>
                <div id="paymentType"><img src="asset/img/mastercard.png"><a>MasterCard</a><img src="asset/icons/arrow-down.svg"></div>
                ...
                <div>
                    <input id="expiry" placeholder="Expiration" minlength=5 maxlength=5 pattern="(0[1-9]|[12][0-9]|3[01])/(0[1-9]|1[0-2])" required>
                ...
                <div>
                    ...
                    <div id="country"><a>Pays/région</a><img src="asset/icons/arrow-down.svg"></div>
                </div>
            </div>
        </div>
        <div id="devis">
        <?php 
            ...
            <figure>
                <img width= "300px" height="255px" src="../asset/test_img/<?php echo($photo["photo"]["name"][0]); ?>">
                <figcaption>Appartement avec vue imprenable sur la mer</figcaption>
            </figure>
            <div>
                <p><a>320€ x 3 nuits</a><a>960€</a></p>
                <p><a>Frais de ménage</a><a>85€</a></p>
                <p><a>Taxes</a><a>20€</a></p>
            </div>
            <div><p><a class="h3">Total</a><a>EUR</a><a class="h3">1065€</a></p></div>
