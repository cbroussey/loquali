    ...
    <main id="ensemble">
        ...
        <div class="infosProprio">
            <div id="infosTous">
                ...
                <div class="infos">
                    <h2>
                        <?php echo $current['nom'] ?>
                        <?php echo ($current['prenom']) ?>
                    </h2>
                    <?php
                    ...
                    if ($_SESSION['userType'] == 'proprietaire') {
                        ...
                        <figure class="tel">
                            ...
                            <figcaption>
                                <?php echo wordwrap($current["numero"], 2, " ", 1); ?>
                            </figcaption>
                        </figure>
                        <?php
                    }
            ...
            <div id="aProposDeMoi">
                ...
                if ($_SESSION['userType'] == 'proprietaire') {
                    ...
                    <div class="descriptionPersonne">
                        <form method="post">
                            <a href="#" id="boutonDescription" class="testBouton"><img
                                    src="asset/icons/bleu/modification.svg" alt="Icone Modification"></a>
                            <input type="submit" value="Enregistrer" id="modificationDescription" class="modifBtn">
                            <?php
                            if (!empty($current["description"])) {
                                ?>
                                <p id="champsDescription" class="descriptionCompte">
                                    <?php echo htmlentities($current["description"] . PHP_EOL) ?>
                                </p>
                                <?php
                            } else {
                                ?>
        ...
        if ($_SESSION['userType'] == 'proprietaire') {
                            ...
                            <div class="listeUnLogement">
                                <div class="imgLogement">
                                    <a href="logement.php?id=<?php echo ($info["id_logement"]) ?>">
                                        <img class="imgPageProprioLog"
                                            src="asset/img/logements/<?php echo ($photo["min"]); ?>.<?php echo $extention["extension_image"] ?>"
                                            width="300px" height="100%"
                                            alt="Image du Logement <?php echo ($info["id_logement"]) ?>">
                                    </a>
                                </div>
                                ...
                                <div class="unLogement">
                                    ...
                                    <p>
                                        <?php echo ($info["code_postal"]); ?>, <U>
                                            <?php echo ($info["departement"]); ?>
                                        </U>
                                    </p>
                                    <div class="noteAvis">
                                        <p>
                                    ...
                                    <a class="consulterLogement"
                                        href="logement.php?id=<?php echo $info["id_logement"] ?>"><em>Consulter le logement</em></a>
                                </div>
            ...
            <?php
        } else { /* Dans le cas ou l'utilisateur est un client, ça fera comme au desSus mais avec les avis laissé par le client */
            ?>
            <div id="logementPropo">
                ...
                <div id="listeLogements">
                    ...
                    try {
                        ...
                        foreach ($dbh->query("SELECT * FROM test.avis NATURAL JOIN test.compte WHERE id_compte = $id", PDO::FETCH_ASSOC) as $row) {

                            $info = $row;
                            $dbh->setAttribute(PDO::ATTR_DEFAULT_FETCH_MODE, PDO::FETCH_ASSOC);
                            $query = "SELECT min(id_image) FROM test.compte NATURAL JOIN test.image WHERE id_compte = :id_compte;";
                            ...
                            <div class="unAvis">
                                <div class="infoPropioAvis">
                                    ...
                                    ?>
                              href="logement.php?id=<?php echo ($info["id_compte"]); ?>&id_log=<?php echo ($id) ?>#AvisSection">
                                        <div class="photo_profil_proprio_log_avis ppAvisLogRrrrowcount<?php echo ($info['id_compte']); ?>"
                                    ...
                                    <div class="infoTxtProprioAvis">
                                        ...
                                        <?php
                                        $dateAff = explode(" ", $info["date_avis"]);
