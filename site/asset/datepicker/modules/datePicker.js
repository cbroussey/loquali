...
function toggleDP(id, caller) {
    ...
    if (DP.style.visibility == "visible"){
        ...
        DP.style.top = `calc(${caller.offsetTop + caller.offsetHeight}px + 1em)`
...
function DPapply() {
    ...
    for (let element of temp) {
        ...
        element.innerHTML = '<div class="DPheader"><a class="DPprev">&lt;</a><div class="DPmonth"></div><a class="DPnext">&gt;</a></div><table><thead><th>Lun.</th><th>Mar.</th><th>Mer.</th><th>Jeu.</th><th>Ven.</th><th>Sam.</th><th>Dim.</th></thead><tbody></tbody></table>'
